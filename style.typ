...
#let m-red = rgb("#05525a")
#let m-extra-light-red = rgb("#add7db")
...
#let title-slide(
  ...
  let content = {
    ...
    set align(horizon)
    place(top + right, pad(top: 10pt, right: 10pt, image("./TACEO_color.svg", format: "svg", width: 100pt)))
...
#let slide(title: none, body) = {
  let header = {
    ...
    place(top + right, pad(top: 10pt, right: 10pt, image("./TACEO_w.svg", format: "svg", width: 100pt)))
  }
